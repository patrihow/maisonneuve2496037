...
@section('title', __('forum.create_article'))

@section('content')
<div class="container mt-4">
    <h1>{{ __('forum.create_article') }}</h1>
    ...
    <form action="{{ route('articles.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea name="content_fr" id="content_fr" class="form-control" rows="5">{{ old('content_fr') }}</textarea>
        </div>
